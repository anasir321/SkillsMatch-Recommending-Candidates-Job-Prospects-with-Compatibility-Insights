...
import MailServerBreadCrumb from '../components/mailserver/mailserverbreadcrumb';
import CareerOfficerJobsArea from '../components/mailserver/careerofficerjobsarea';
  ...
  return (
    <Wrapper>
      <div className="main-page-wrapper">
        ...
        <MailServerBreadCrumb/>
        {/* job details breadcrumb end */}

        {/* job details area start */}
        <CareerOfficerJobsArea job={job}/>
