          ...
          <div className="row">
            <div className="col-xl-6 m-auto text-center">
              <div className="title-two">
                <h2 className="text-white">Jobs by Career Officers</h2>
              </div>
              {/* <p className="text-lg text-white mt-30 lg-mt-20">
                Here will be your job details & requirements
              </p> */}
            </div>
          </div>
        </div>
...
export default MailServerBreadCrumb;
