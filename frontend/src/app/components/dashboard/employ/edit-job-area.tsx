...
const EditJobArea = ({setIsOpenSidebar}:IProps) => {
  ...
  useEffect(() => {
    // get job details by job_id
      ...
      try {
        ...
        console.log("edit-job-area :: getJobDetailsUsingId :: response.data.data.job: ", response.data.data.job);
  ...
  return (
    <div className="dashboard-body">
      <div className="position-relative">
        ...
        <h2 className="main-title">Edit this job</h2>
