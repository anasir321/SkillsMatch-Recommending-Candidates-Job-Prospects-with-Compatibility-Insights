...
const AppliedCandidatesArea = ({setIsOpenSidebar}:IProps) => {
        ...
        try {
          const response = await axios.get(
            ...
            if (response.status === 200) {
              console.log("applied-candidates-area :: getapplicants :: response.data.data.candidates: ", response.data.data.candidates);
    ...
    <div className="dashboard-body">
      <div className="position-relative">
        ...
        <div className="d-flex align-items-center justify-content-between mb-40 lg-mb-30">
          <h2 className="main-title m0">Applicants of this Job</h2>
...
export default AppliedCandidatesArea;
