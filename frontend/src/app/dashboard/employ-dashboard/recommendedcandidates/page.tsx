...
import RecommendedCandidatesArea from "@/app/components/dashboard/employ/recommended-candidates-area";
  ...
  return (
    <Wrapper>
      <div className="main-page-wrapper">
        ...
        <RecommendedCandidatesArea setIsOpenSidebar={setIsOpenSidebar} />
